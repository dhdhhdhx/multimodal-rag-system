...
const navItems = [
  ...
  { path: '/admin/topics', label: '话题管理', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>' },
...
const pageTitles: Record<string, string> = {
  ...
  '/admin/documents': '文档管理', '/admin/tags': '标签管理', '/admin/topics': '话题管理', '/admin/stats': '数据统计'
}
